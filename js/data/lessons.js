/**
 * Lesson plan for the Spanish keyboard, ordered from the home row outwards.
 *
 * A lesson is either:
...
export function lessonsOfBlock(blockId) {
  return LESSONS.filter((lesson) => lesson.block === blockId);
}
